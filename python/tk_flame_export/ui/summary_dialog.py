...
class Ui_SummaryDialog(object):
    def setupUi(self, SummaryDialog):
        ...
        self.status = QtGui.QLabel(self.page)
    ...
    def retranslateUi(self, SummaryDialog):
        ...
        self.label_3.setText(QtGui.QApplication.translate("SummaryDialog", "Submission Complete!", None, QtGui.QApplication.UnicodeUTF8))
        self.status.setText(QtGui.QApplication.translate("SummaryDialog", "TextLabel", None, QtGui.QApplication.UnicodeUTF8))
